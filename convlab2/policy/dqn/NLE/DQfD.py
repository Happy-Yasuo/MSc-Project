...
class DQfD(Policy):
    ...
    def __init__(self, train=True):
        ...
        self.scheduler = StepLR(self.optimizer, step_size=cfg['lr_decay_step'], gamma=cfg['lr_decay'])
    ...
    def compute_loss(self, s, a, r, s_next, mask, expert_label, candidate_a_ind):
